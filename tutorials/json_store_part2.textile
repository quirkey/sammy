...
<div class="warning">
  This tutorial is currently under reconstruction. It was written for Sammy v0.4 and is being updated for the changes in the latest version v0.6. The basic concepts are the same, but some of the syntax has changed. Sorry for the inconvenience. You can stay tuned to changes by "watching the github repo":http://github.com/quirkey/sammy/commits/gh-pages
</div>
