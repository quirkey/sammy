...
You'll notice write away that the format looks a lot like our routes. This is intentional. More than just the look, @this@ inside of a @bind()@ is also an @EventContext@, just like within a route. This means that all our helpers work the same within these event bindings.
