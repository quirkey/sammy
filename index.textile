...
There are also some basic but functional examples (with more coming) in the "examples/ folder":http://github.com/quirkey/sammy/tree/master/examples/

You can also follow the latest updates on twitter: "@sammy_js":http://twitter.com/sammy_js