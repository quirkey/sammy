(function(window) {
  ...
  Sammy.extend(Sammy.Store.prototype, {
    ...
    _removeKey: function(key) {
      var keys = this.keys();
      var index = Sammy.inArray(key, keys);
  ...
  Sammy.extend(Sammy.Store.Data.prototype, {
    isAvailable: function() { return true; },
    exists: function(key) {
  ...
  Sammy.extend(Sammy.Store.SessionStorage.prototype, {
    isAvailable: function() {
      return ('sessionStorage' in window) &&
      (window.location.protocol != 'file:') &&
      (Sammy.isFunction(window.sessionStorage.setItem));
    },
    exists: function(key) {
      return (this.get(key) != null);
    },
  ...
  Sammy.extend(Sammy.Store.Cookie.prototype, {
    isAvailable: function() {
  ...
  Sammy.Storage = function(app) {
    ...
    this.store = function(name, options) {
      ...
      if (typeof this.stores[name] == 'undefined') {
        ...
        this.stores[name] = new Sammy.Store(Sammy.extend({
          name: name,
        ...
        this[name] = function(key, value) {
          ...
          } else if (Sammy.isFunction(value)) {
  ...
  Sammy.Session = function(app, options) {
    ...
    this.store('session', Sammy.extend({type: ['local', 'cookie', 'memory']}, options));
  };
  ...
  Sammy.Cache = function(app, options) {
    ...
    this.store('cache', Sammy.extend({type: ['local', 'session', 'memory']}, options));
  };
