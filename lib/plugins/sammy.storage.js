(function($) {
  ...
  $.extend(Sammy.Store.prototype, {
    ...
    fetch: function(key, callback) {
      if (!this.exists(key)) {
        this.set(key, callback.apply(this));
      }
    },
  ...
  Sammy.Storage = function(app) {
    ...
    this.store = function(name, options) {
      ...
      if (typeof this.stores[name] == 'undefined') { 
        ...
        this[name] = function(key, value) {
          ...
          } else if ($.isFunction(value) && !this.stores[name].exists(key)) {
        ...
        delegate[name] = function() {
          return this.app[name].apply(arguments);
        };
        this.helpers(delegate);
      }
    ...
    this.helpers({
      store: function() {
        return this.app.apply(this, arguments);
      }
    });
