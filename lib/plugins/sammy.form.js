(function($) {
  ...
  $.extend(Sammy.FormBuilder.prototype, {
    ...
    radioField: function(keypath, value, attributes) {
      var selected;
      attributes = $.extend(this.attributesForKeyPath(keypath), attributes);
      selected = attributes.value;
    ...
    checkboxField: function(keypath, value, attributes) {
      return this.radioField(keypath, value, $.extend({type: 'checkbox'}, attributes));
    },
