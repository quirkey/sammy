(function($) {
    ...
    var myBind = function (func, arr) {
        return Handlebars[func].apply(Handlebars, arr);
    }
    
    // export some desired functionality
    Sammy.Handlebars.SafeString = function (string) {
        return myBind('SafeString', [].slice.call(arguments));
    },
    Sammy.Handlebars.registerHelper = function (name, fn, inverse) {
        return myBind('registerHelper', [].slice.call(arguments));
    }
