  ...
  Sammy.FormParametersParser = {
    ...
    _insertFieldIntoParameters: function(field_value, field_name, params) {
      ...
      if (field_name.match(/^[^\[]+$/)) {
        ...
        if (params[name]) {          
          $.extend(true, params[name], context._insertFieldIntoParameters(field_value, rest, params[name]));
        } else {
          params[name] = context._insertFieldIntoParameters(field_value, rest, {});
        }
      }
      return params;
    }
