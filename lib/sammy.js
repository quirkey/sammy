...
(function($, window) {
  ...
  Sammy.Adapter.jQuery.prototype.select = function(selector) {
    return $(selector);
  };

  Sammy.Adapter.jQuery.prototype.addDomListener = function(selector, name, callback) {
    return $(selector).bind(name, callback);
  };

  Sammy.Adapter.jQuery.prototype.removeDomListener = function(selector, name) {
    return $(selector).unbind(name);
  };

  Sammy.Adapter.jQuery.prototype.triggerDomEvent = function(selector, name, data) {
    return $(selector).trigger(name, data);
  };

  Sammy.Adapter.jQuery.prototype.listenForFormSubmission = function() {
    var app = this.app;
  ...
  Sammy.Adapter.jQuery.prototype.unlistenForFormSubmission = function() {
