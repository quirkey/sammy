;(function($) {
  ...
  Sammy.Application.prototype = $.extend({}, Sammy.Object.prototype, {
    ...
    mapRoutes: function(route_array) {
      this.each(route_array, function(i, route_args) {
        this.route.apply(this, route_args);
      });
      return this;
    },
    ...
    _checkFormSubmission: function(form) {
      ...
      this.log('form', $form, 'verb', verb, 'path', path);
      try { // catch 404s
        returned = this.runRoute(verb, path, params);
        this.log('returned', returned);
      } catch(e) {
        this.log('error', e, 'app', this);
        if (e.toString().match(/^404/) && this.silence_404) {
          return true;
        } else {
          throw(e);
