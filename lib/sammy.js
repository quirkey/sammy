...
(function($, window) {
  ...
  Sammy.RenderContext.prototype = $.extend({}, Sammy.Object.prototype, {
    ...
    renderEach: function(location, name, array, data, callback) {
      if (_isArray(name)) {
        callback = data;
        data = array;
        array = name;
      ...
      return this.load(location).then(function(content) {
          var rctx = this;
          if (!array) {
            array = _isArray(this.previous_content) ? this.previous_content : [];
          }
          if (callback) {
            $.each(array, function(i, value) {
              var idata = data || {}, engine = this.next_engine || location;
              name ? (idata[name] = value) : (idata = value);
              callback(value, rctx.event_context.interpolate(content, idata, engine));
            });
          } else {
            return this.collect(array, function(i, value) {
              var idata = data || {}, engine = this.next_engine || location;
              name ? (idata[name] = value) : (idata = value);
