    ...
    _startPolling: function(every) {
      ...
      if (!Sammy.HashLocationProxy._interval) {
        ...
        Sammy.HashLocationProxy._interval = setInterval(function() {
          if (Sammy.HashLocationProxy._last_hash && proxy.getLocation() != Sammy.HashLocationProxy._last_hash) {
            Sammy.log('triggering hashchange');
            $(window).trigger('hashchange')
          } 
          Sammy.HashLocationProxy._last_hash = proxy.getLocation();
        }, every);
