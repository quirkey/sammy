...
(function($, window) {
  ...
  Sammy.Application.prototype = _extend({}, Sammy.Object.prototype, {
    ...
    _checkFormSubmission: function(form) {
      var formObject, params, returned;
      formObject = this.adapter.serializeFormIntoObject(form);
      if (formObject.verb === 'get') {
        this.setLocation(formObject.action + '?' + this._serializeFormParams(formObject));
        returned = false;
      } else {
        params = _extend({}, this._parseFormParams(formObject));
        returned = this.runRoute(formObject.verb, formObject.action, params, form);
      };
      return (typeof returned == 'undefined') ? false : returned;
    },

    _serializeFormParams: function(formObject) {
       var queryString = "",
    ...
    _parseFormParams: function(formObject) {
      var params = {},
          fields = formObject.fields,
          i = 0;
      for (; i < fields.length; i++) {
