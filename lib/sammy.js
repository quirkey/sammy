...
(function(window) {
  ...
  var Sammy,
      ...
      _defer  = function(fun, thisArg, timeout) {
        return window.setTimeout(function() { fun.apply(thisArg); }, timeout || 13);
      },
    ...
    _startPolling: function(every) {
      ...
      if (!Sammy.HashLocationProxy._interval) {
        ...
        var hashCheck = function() {
          ...
          if (!Sammy.HashLocationProxy._last_location || current_location != Sammy.HashLocationProxy._last_location) {
