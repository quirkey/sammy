...
(function($, window) {
  ...
  Sammy.Adapter.jQuery = function(app) {
    this.app = app;
  };

  _extend(Sammy.Adapter.jQuery.prototype, {
    ...
    listenForFormSubmission: function() {
      var app = this.app;
      return this.app.element().bind('submit', function(e) {
        var returned = app._checkFormSubmission($(e.target).closest('form')[0]);
        return (returned === false) ? e.preventDefault() : false;
      });
    },

    unlistenForFormSubmission: function() {
      return this.app.element().unbind('submit');
    },
  ...
  Sammy.Application = function(app_function) {
    var app = this;
    this.adapter           = new Sammy.Adapter.jQuery(this);
    this.routes            = {};
  ...
  Sammy.Application.prototype = _extend({}, Sammy.Object.prototype, {
    ...
    run: function(start_url) {
      ...
      this.adapter.listenForFormSubmission();
    ...
    unload: function() {
      ...
      this.adapter.unlistenForFormSubmission();
      this._running = false;
      return this;
    },
