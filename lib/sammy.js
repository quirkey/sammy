...
;(function($) {
  ...
  Sammy.Application.prototype = $.extend({}, Sammy.Object.prototype, {
    ...
    runRoute: function(verb, path, params) {
      ...
      var context, befores, before, returned,
      ...
      if (route) {
        ...
        while (befores.length > 0) {
          ...
          // check the options
          if (this.routeMatchesOptions(context, before[0])) {
    ...
    routeMatchesOptions: function(route, match_options, positive) {
      ...
      wrapped_callback = function(response) {
        ...
        $.each(data_array, function(i, idata) {
          ...
          if ($.isFunction(engine)) {
            new_content = c.apply(context, [response, idata]);
          } 
          // collect the content
