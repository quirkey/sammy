...
(function($, window) {
  ...
  Sammy.Adapter.jQuery.prototype.triggerDomEvent = function(selector, name) {
    return $(selector).trigger(name);
  };
  ...
  Sammy.Application.prototype = _extend({}, Sammy.Object.prototype, {
    ...
    run: function(start_url) {
      ...
      this.adapter.listenForFormSubmission('submit', function(e) {
        var returned = app._checkFormSubmission($(e.target).closest('form'));
        return (returned === false) ? e.preventDefault() : false;
      });
