...
(function($) {
  ...
  if (typeof window.console != 'undefined') {
    Sammy.Object.addLogger(window.console.log);
  } else if (typeof console != 'undefined') {
    Sammy.Object.addLogger.push(console.log)
  }
  ...
  $.extend(Sammy.Object.prototype, {    
    ...
    // Sends a log message asynchronously to each logger listed in the global
    // loggers pool.
  ...
  Sammy.Application = function(app_function) {
    ...
    this.context_prototype = Sammy.EventContext;
  ...
  Sammy.Application.prototype = $.extend({}, Sammy.Object.prototype, {
    ...
    bindToAllEvents: function(callback) {
      ...
      this.each(this.listeners.keys, function(i, name) {
