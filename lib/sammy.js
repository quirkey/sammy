...
(function($, window) {
  (function(factory){
    ...
    if (typeof define === 'function' && define.amd){
      ...
      // our plugins may be loaded out of turn (async),
      // but most of them are clever enough to set up
      // a global Sammy object ( window.Sammy = {} ) and extend it.
      // If that exists, we will extend ourselves with methods / properties
      // attached by plugins to that object.
      if (typeof window.Sammy === 'object') {
        $.sammy = window.Sammy = $.extend(factory($), window.Sammy);
      } else {
