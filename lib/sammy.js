...
(function($) {
  ...
  Sammy.EventContext = Sammy.Object.extend({
    ...
    render: function(type, selector, content, options) {
      return this[this.render_types[type]](selector, content, options);
    },
    
    renderText: function(selector, content, options) {
    ...
    renderHTML: function(selector, content, options) {
    ...
    renderPartial: function(selector, content, options) {
      var context = this;
    ...
    renderTemplate: function(selector, content, options) {
