describe('Sammy.Flash', function() {
  ...
  describe('app.Flash', function() {
    ...
    it('retains entries after a non-redirect', function(done) {
    ...
    it('retains entries after a redirect', function(done) {
      $('#main').html('<form id="test_form" method="post" action="#/test"></form>');
      app.get('#/trigger', function() { this.trigger('done'); });
      app.get('#/', function() {});
      app.run('#/');
      app.bind('done', function() {
        expect(app.flash['nested params info']).to.eql("Successfully POSTed nested params");
        app.unload();
        done();
      });
      app.post('#/test', function() {
        this.flash('nested params info', "Successfully POSTed nested params");
        this.redirect('#/trigger');        
      })
      $('#test_form').submit();
    });
